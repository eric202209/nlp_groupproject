...
"""
The new_comment used by the program is for homework use. 
I have no intention of discriminating against others 
or even hating others.

Please pip install sklearn, nltk at the beginning
"""
...
def main():
    ...
    split_index = int(0.75 * len(data_shuffled))
    train_data, test_data = data_shuffled[:split_index], data_shuffled[split_index:]
    ...
    #test_comments = test_data.apply(preprocess_text)
    #X_test_tfidf = tfidf_vectorizer.transform(test_comments)
